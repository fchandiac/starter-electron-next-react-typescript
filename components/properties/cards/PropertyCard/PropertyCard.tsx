...
const PropertyCard: React.FC<PropertyCardProps> = ({
    ...
    return (
        ...
        {/* Overlay al hacer hover */}
                            {/* Overlay al hacer hover */}
                            <div className="absolute inset-0 bg-foreground opacity-0 group-hover:opacity-30 transition-opacity duration-200 z-30 pointer-events-none" />
